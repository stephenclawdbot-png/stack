...
export function PickaxeIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M14.531 12.469L6.619 20.38a1 1 0 0 1-3.404-1.276 1 1 0 0 1-.133-1.375L11.063 9.47" />
      <path d="M6.47 9.47a9.5 9.5 0 0 1 11.06 0c1.71-1.71 2.44-3.44 2.44-3.44S18.24 6.24 16.53 7.95c1.71 1.71 3.44 2.44 3.44 2.44s-1.73.73-3.44 2.44a9.5 9.5 0 0 1-11.06 0" />
    </svg>
  );
}
...
export function FactoryIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M2 20h20" />
      <path d="M4 20V8l6 4V8l6 4V8l4 4v8" />
